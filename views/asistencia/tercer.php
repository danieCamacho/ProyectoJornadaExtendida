						...
						<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
							...
							<?php if($centro[0]->categoria == 2) {
								...
								<?php
									...
									?>
									<li class="nav-item">
										<a role="tab" class="nav-link" href="?controller=asistencia&method=view&id=<?php echo $cursos[1]->id_curso ?>&ca=2">
								...
								<?php
									...
									?>
									<li class="nav-item">
										<a role="tab" class="nav-link" href="?controller=asistencia&method=view&id=<?php echo $cursos[3]->id_curso ?>&ca=2">
							...
							<?php if($centro[0]->categoria == 3) {
								?>
                                <li class="nav-item">
                                    <a role="tab" class="nav-link active" href="?controller=asistencia&method=deporte&id=<?php echo $cursos[0]->id_curso ?>&ca=1">
										...
										<section class="col-md-12 table-responsive">
											...
											<div class="collapse" id="collapseExample">
												<div class="card card-body m-3">
													<?php if($centro[0]->categoria == 3){
														?>
															<form action="?controller=clase&method=save&plan=<?php echo $centro[0]->plan ?>" method="POST">
														<?php
														}elseif($centro[1]->categoria == 3){
														?>
															<form action="?controller=clase&method=save&plan=<?php echo $centro[1]->plan ?>" method="POST">
														<?php
														}elseif($centro[2]->categoria == 3){
														?>
															<form action="?controller=clase&method=save&plan=<?php echo $centro[2]->plan ?>" method="POST">
														<?php
															}elseif($centro[3]->categoria == 3){
																?>
															<form action="?controller=clase&method=save&plan=<?php echo $centro[3]->plan ?>" method="POST">
														<?php
													}
													?>
													<!--<form action="?controller=clase&method=save&plan=<?php echo $centro[0]->plan ?>" method="POST">-->
														<div class="row">
															...
															<div class="col-md-10">
																<div class="form-group">
																	<label class="float-left" for="descripcion">Descipción</label>
												...
												<div class="row">
													...
													<div class="col-md-5 mt-2">
														<div class="form-group">
															...
															<input type="hidden" name="categoria" id="categoriafecha" value="3">
														</div>
													</div>
