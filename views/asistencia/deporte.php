					...
					<div class="card-header-tab card-header">
						<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
							...
							<?php if($centro[0]->categoria == 2) {
								?>
									<li class="nav-item">
										<a role="tab" class="nav-link" href="?controller=asistencia&method=view&id=<?php echo $cursos[0]->id_curso ?>&ca=2">
										...
										<section class="col-md-12 table-responsive">
											...
											<div class="collapse" id="collapseExample">
												<div class="card card-body m-3">
                                                    <form action="?controller=clase&method=savemax&plan=<?php echo $deporteMax[0]->id_plan ?>" method="POST">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="float-left" for="fecha">Fecha</label>
                                                                    <input id="fecha" name="fecha" type="date" class="form-control" placeholder="Fecha Clase" required readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
																	...
																	<?php if($max == false) { ?>
																		<input class="form-control" id="centro" value="Deporte 1" readonly required>
																	<?php }else{?>
																		<input class="form-control" id="centro" value="<?php echo $deporteMax[0]->centro ?>" readonly required>
																		<input type="hidden" id="centrofecha" value="<?php echo $deporteMax[0]->id_centro ?>">
																	<?php	
																	}
																	?>
                                                                </div>
														...
														<?php if($max == false) { ?>
															<div class="modal-footer float-right">
																<a class="btn btn-secondary">Agregar</a>
															</div>
														<?php }else{?>
															<div class="modal-footer float-right">
											...
											<table class="table table-striped table-hover">
												<thead>
													<tr>
														...
														<th>Apellido</th>
														<th>Documento</th>
														<?php if($fechaMax == false){
															?>
                                                                <th>Realiza la clase</th>
                                                            <?php
														}else{
                                                            ?>
                                                                <?php foreach ($fechaMax as $fecha) : ?> 
												...
												<tbody>
													...
													<?php }else{ ?>
														<?php foreach ($deporteMax as $inscripcion) : ?>
															<tr>
												...
												<div class="row">
													...
													<div class="col-md-5 mt-2">
														<div class="form-group">
															...
															<input type="hidden" name="categoria" id="categoriafecha" value="1">
														</div>
													</div>
                            ...
                            <div class="row">
								<div class="col-md-6 mt-3">
									<div class="main-card mb-3 card">
										...
										<section class="col-md-12 table-responsive">
											<div>
												<a class="btn btn-primary float-right m-3" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-plus"></i> Clase</a>
											</div>
											<div class="collapse" id="collapseExample1">
												<div class="card card-body m-3">
                                                    <form action="?controller=clase&method=savemin&plan=<?php echo $deporteMin[0]->id_plan ?>" method="POST">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="float-left" for="fecha">Fecha</label>
                                                                    <input id="fechae" name="fecha" type="date" class="form-control" placeholder="Fecha Clase" required readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
																	<label class="float-left" for="centro">Centro de Interés</label>
																	<?php if($min == false) { ?>
																		<input class="form-control" id="centro" value="Deporte 2" readonly required>
																	<?php }else{ ?>
																		<input class="form-control" id="centro" value="<?php echo $deporteMin[0]->centro ?>" readonly required>
																		<input type="hidden" id="centrofechamin" value="<?php echo $deporteMin[0]->id_centro ?>">
																	<?php }?>
                                                                </div>
                                                            </div>		
                                                            <div class="col-md-10">
											...
											<table class="table table-striped table-hover">
												<thead>
													<tr>
														...
														<th>Apellido</th>
														<th>Documento</th>
														<?php if($fechaMin == false){
															?>
                                                                <th>Realiza la clase</th>
                                                            <?php
														}else{
                                                            ?>
                                                                <?php foreach ($fechaMin as $fecha) : ?> 
                                                                    <th><a href="?controller=clase&method=view&clase=<?php echo $fecha->id_clase ?>" class="text-light"><?php echo $fecha->fecha ?></a></th>
                                                                <?php endforeach ?>
															<?php
														}?>
												...
												<tbody>
													...
													<?php }else{ ?>
														<?php foreach ($deporteMin as $inscripcion) : ?>
															<tr>
															<form action="?controller=asistencia&method=save" method="POST">
																<td><?php echo $inscripcion->nombre; ?></td>
																<td><?php echo $inscripcion->apellido;?></td>
										...
										<section class="col-md-12 table-responsive">
                                            <form action="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 mt-2">
                                                        <div class="form-group">
                                                            <input type="date" name="fecha" id="fechaescogidamin" class="form-control">
                                                            <input type="hidden" name="categoria" id="categoriafechamin" value="1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mt-2">
                                                        <div class="form-group">
                                                            <input type="button" id="buttonforma" class="btn btn-primary" value="Buscar">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
											<div id="fechasistenciamin"></div>
										</section>
								</div>
						</div>
					</div>
