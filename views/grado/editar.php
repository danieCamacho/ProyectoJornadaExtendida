				...
				<div class="card-body">
                    ...
                    <div class="card-header-tab card-header">
                        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                            <li class="nav-item">
                                <a role="tab" class="nav-link" href="?controller=grado">
                            ...
                            <div class="mb-3 card">
                                <form action="?controller=grado&method=update" method="POST">
                                    <div class="modal-body">
                                        <h4 class="m-2">Editar Grado <?php echo $data[0]->nombre?></h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="hidden" name="id_grado" value="<?php echo $data[0]->id_grado?>">
                                                    <label class="float-left" for="nombre">Nombre</label>
                                                    <input id="nombre" name="nombre" type="text" class="form-control" placeholder="Nombre Grado" onkeypress="return soloLetras(event)" value="<?php echo $data[0]->nombre ?>" require>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="float-left" for="jornada">Jornada</label>
                                                    <input id="jornada" name="jornada" type="text" class="form-control" placeholder="Jornada del Grado" onkeypress="return soloLetras(event)" value="<?php echo $data[0]->jornada ?>" require>
                                                </div>
                                            </div>
                                        </div>
